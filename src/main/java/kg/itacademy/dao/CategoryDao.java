...
public class CategoryDao {
    ...
    private static final Map<Integer, Category> categoryMap = new HashMap<Integer, Category>();
    ...
    private static void initCats() {
        ...
        Category c1 = new Category(1, "Расходы на питание", UserDao.getUser(1), true);
        Category c2 = new Category(2, "Транспорт", UserDao.getUser(1), true);
        Category c3 = new Category(3, "Развлечения", UserDao.getUser(1), true);
        Category c4 = new Category(4, "Развлечения", UserDao.getUser(2), true);
