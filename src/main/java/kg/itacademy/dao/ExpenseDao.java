...
public class ExpenseDao {
    ...
    private static final Map<Integer, Expense> ExpenseMap = new HashMap<Integer, Expense>();
    ...
    private static void initCats() {
        ...
        Expense c1 =
                new Expense(1, CategoryDao.getCat(1), BigDecimal.TEN, "Проезд", UserDao.getUser(1),
                        WalletDao.getWal(1), true);
